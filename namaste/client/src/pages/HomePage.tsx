...
import { 
    ...
    const systemFeatures = [
        ...
        stats: `${stats?.totalCodes?.toLocaleString() || '4,500+'}  codes`
        },
        {
        ...
        stats: `${stats?.systemsActive || '3'} systems`
        },
        {
        icon: <Shield className="h-6 w-6 text-orange-600" />,
        title: "Dual Coding",
        description: "Traditional + International codes",
        stats: `${stats?.successRate || '97.8'}% accuracy`
        }
    ];
    ...
    const systemMetrics = [
        { 
        label: "Active Medical Systems", 
        value: loading ? "..." : String(stats?.systemsActive || "3"), 
        trend: "stable" 
        },
        { 
        label: "Total Translations", 
        value: loading ? "..." : (stats?.fhirResources?.toLocaleString() || "7,133"), 
        trend: "up" 
        },
        { 
        label: "Success Rate", 
        value: loading ? "..." : `${stats?.successRate || "97.8"}%`, 
        trend: "up" 
        },
        { 
        label: "Daily Users", 
        value: loading ? "..." : String(stats?.activeUsers || "10"), 
        trend: "up" 
        }
    ];
    ...
    return (
        ...
        <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r-lg">
            ...
            <div className="ml-3">
                ...
                <strong>महत्वपूर्ण सूचना | Important Notice:</strong> This system is compliant with National Digital Health Mission (NDHM) 
                standards and integrates with ABDM (Ayushman Bharat Digital Mission) ecosystem.
                </p>
            </div>
            </div>
        </div>

        {/* Hero Section with Government Design */}
        <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 via-white to-orange-50 shadow-lg">
            <CardHeader className="text-center py-16">
            {/* Government Emblem */}
            <div className="flex justify-center mb-8">
                <div className="relative">
                <div className="w-24 h-24 bg-gradient-to-br from-orange-100 to-blue-100 rounded-full flex items-center justify-center shadow-lg border-4 border-white">
            ...
            <div className="space-y-4 mb-8">
                ...
                <div className="text-xl text-blue-800 font-medium max-w-4xl mx-auto">
                National Ayurveda Medical Standards and Terminology Exchange
                </div>
            </div>
            
            {/* Subtitle */}
            <div className="text-lg text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                ...
                className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105"
                >
                ...
                <Button 
                variant="outline" 
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-8 py-4 text-lg font-semibold rounded-lg shadow-md transition-all duration-300"
                >
        ...
        {/* System Features - Government Style Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {systemFeatures.map((feature, index) => (
            <Card key={index} className="border-2 border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all duration-300 group">
                <CardHeader className="pb-3">
                <div className="flex items-center justify-between mb-3">
                    <div className="p-3 bg-gradient-to-br from-orange-50 to-blue-50 rounded-xl group-hover:scale-110 transition-transform duration-300">
                    {feature.icon}
                    </div>
                    <Badge variant="secondary" className="bg-gradient-to-r from-orange-100 to-blue-100 text-gray-800 font-semibold">
                    {loading ? <Loader2 className="h-3 w-3 animate-spin" /> : feature.stats}
                    </Badge>
                </div>
                </CardHeader>
                <CardContent>
        ...
        <Card className="border-2 border-gray-200 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <Button
                    ...
                    className={`capitalize font-semibold px-6 py-3 ${
                    activeTab === tab 
                        ? 'bg-gradient-to-r from-orange-600 to-blue-600 text-white shadow-md' 
                        : 'border-gray-300 text-gray-700 hover:bg-gradient-to-r hover:from-orange-50 hover:to-blue-50 hover:border-orange-300'
                    }`}
                >
            ...
            {activeTab === 'overview' && (
                <div className="space-y-8">
                {/* Mission Statement */}
                <div className="bg-gradient-to-r from-orange-50 to-blue-50 rounded-lg p-6 border-l-4 border-orange-500">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-700">आयुर्वेद, सिद्ध, यूनानी की 4,500+ पारंपरिक चिकित्सा शब्दावली</p>
            ...
            {activeTab === 'metrics' && (
                ...
                <div className="bg-gradient-to-r from-blue-50 to-orange-50 rounded-lg p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <span className="text-gray-700">कुल अनुवाद</span>
                        <span className="font-bold text-blue-600">{stats?.fhirResources?.toLocaleString() || '7,133'}</span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                        <span className="text-gray-700">सफलता दर</span>
                        <span className="font-bold text-green-600">{stats?.successRate || '97.8'}%</span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                        <span className="text-gray-700">दैनिक उपयोगकर्ता</span>
                        <span className="font-bold text-orange-600">{stats?.activeUsers || '10'}</span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card key={index} className="border-2 border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all duration-300 group">
                        ...
                        <CardTitle className="flex items-center gap-3 text-lg">
                            <div className="p-2 bg-gradient-to-br from-orange-50 to-blue-50 rounded-lg group-hover:scale-110 transition-transform duration-300">
                            {useCase.icon}
                            </div>
                            <div>
        ...
        <Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 via-white to-blue-50 shadow-lg">
